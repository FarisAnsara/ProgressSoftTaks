...
public class Main{
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(Arrays.deepToString(matrix1.squareMatOps(SqaureOpsTypes.DIAGONAL).getElements()));
        System.out.println(Arrays.deepToString(matrix1.squareMatOps(SqaureOpsTypes.LOWER).getElements()));
        System.out.println(Arrays.deepToString(matrix1.squareMatOps(SqaureOpsTypes.UPPER).getElements()));
